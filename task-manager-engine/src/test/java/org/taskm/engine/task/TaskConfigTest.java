...
public class TaskConfigTest {
    ...
    public static void setUp() throws EngineException, ParseException, TaskCoreException {
        ...
        eTaskGroup1 = new TaskGroup("Group_1",true,true,"0/5 * * * * ?");
        ...
        eTaskGroup2 = new TaskGroup("Group_2",false,false,"0/7 * * * * ?");
    ...
    public void test_Group1(){
        ...
        TaskGroup taskGroup = (TaskGroup) parser.getTaskGroupList().get(0);
        assert taskGroup.isRunningOnce();
    ...
    public void test_Group2(){
        ...
        TaskGroup taskGroup = (TaskGroup) parser.getTaskGroupList().get(1);
        assert !taskGroup.isRunningOnce();
